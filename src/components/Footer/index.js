          ...
          <div>
            ...
            <div className="text-gray-300 text-sm">
              <p className="mb-2 flex items-center">
                ...
                <a href={contactInfo.phone1.href} className="hover:text-gfc-gold transition-colors">
              ...
              <p className="mb-2 flex items-center">
                ...
                <a href={contactInfo.phone2.href} className="hover:text-gfc-gold transition-colors">
                  {" "}{contactInfo.phone2.number}
                </a>
              </p>
              <p className="flex items-center">
                <FaEnvelope className="text-gfc-gold mr-2" />
                <a href={contactInfo.email.href} className="hover:text-gfc-gold transition-colors">
